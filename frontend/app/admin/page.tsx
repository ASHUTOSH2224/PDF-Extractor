													...
													<div className="flex items-center justify-end gap-2">
															...
															<Tooltip>
																<TooltipTrigger asChild>
																	<Button 
																		...
																		className={u.is_approved ? "opacity-50" : ""}
																...
																<TooltipContent>
																	<p>{u.is_approved ? "User is already approved" : "Approve user"}</p>
																</TooltipContent>
															</Tooltip>
														</TooltipProvider>
														...
														<TooltipProvider>
															<Tooltip>
																...
																<TooltipContent>
																	<p>{!u.is_approved ? "User must be approved first" : "Edit password"}</p>
																</TooltipContent>
															</Tooltip>
														</TooltipProvider>
													</div>

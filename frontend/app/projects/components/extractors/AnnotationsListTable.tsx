...
import { apiService, AnnotationListItem, DocumentExtractionJob } from "../../../services/api";
  ...
  useEffect(() => {
    const fetchAnnotations = async () => {
      ...
      try {
        ...
        const data = await apiService.getAnnotationsList(
          projectId,
          documentId,
          token,
          filters
            ...
            <TableBody>
              {annotations.map((annotation) => (
                ...
                >
                  ...
                  <TableCell className="text-sm">{annotation.extractor}</TableCell>
                  <TableCell className="text-sm text-muted-foreground">
                    {annotation.user_name || 'Unknown'}
                  </TableCell>
                  <TableCell className="max-w-md">
                    <div className="text-sm" title={annotation.text}>

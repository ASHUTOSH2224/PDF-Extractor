import { DocumentExtractionJob, DocumentPageContent, AnnotationResponse, Document } from "../../services/api";

export type ContentViewMode = 'combined' | 'text' | 'table' | 'markdown' | 'latex';
